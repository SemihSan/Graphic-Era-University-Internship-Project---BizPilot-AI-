# BizPilot AI Sample Past Proposal
...
Proposed solution: deploy BizPilot AI as a Streamlit-based chatbot connected to company sales documents and lead-scoring workflow
